    ...
    return (
        <div className="mt-2 mb-2">
            <div className="p-4 mb-4 bg-white shadow-md rounded-md">
                ...
                <input className="mt-2 text-lg font-semibold" onChange={(e:any)=>setCommentContent(e.target.value)}  value={commentContent} disabled = {user?.nickname !== comment.nickname}/>
